...
from .models import Story, StoryTemplate, StoryTemplateContext, StoryTemplatePeriodOfInterestValues, LookupCategory, LookupValue

@admin.register(Story)
class StoryAdmin(admin.ModelAdmin):
    list_display = ('title', 'published_date', 'reference_period_start', 'reference_period_end')
...
class StoryTemplateContextAdmin(admin.ModelAdmin):
    ...
    sortable_by = ('story_template','sort_key',)
    sorted_by = ('sort_key',)
...
class StoryTemplatePeriodOfInterestValuesAdmin(admin.ModelAdmin):
    ...
    sortable_by = ('story_template','sort_key',)
    sorted_by = ('story_template','sort_key',)
...
class LookupValueAdmin(admin.ModelAdmin):
    ...
    sortable_by = ('id', 'sort_order',)
    sorted_by = ('category', 'sort_order',)

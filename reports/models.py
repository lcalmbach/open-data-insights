...
class LookupCategory(models.Model):
    ...
    name = models.CharField(
        max_length=255,
        help_text="Name of the lookup category."
    )
    description = models.TextField(
        blank=True,
        help_text="Description of the lookup category."
    )
...
class LookupValue(models.Model):
    ...
    value = models.CharField(
        max_length=255,
        help_text="The actual lookup value."
    )
    description = models.TextField(
        blank=True,
        help_text="Description of the lookup value."
    )
...
class StoryTemplate(models.Model):
    ...
    title = models.CharField(
        max_length=255,
        help_text="Title of the story template."
    )
    description = models.TextField(
        blank=True,
        help_text="Description of the story template."
    )
...
class Story(models.Model):
    ...
    content = models.TextField(
        help_text="Content of the story.",
        blank=True,
        null=True
    )
...
class StoryRating(models.Model):
    ...
    rating = models.IntegerField(
        help_text="Rating given to the story."
    )
    ...
    rating_text = models.TextField(
        blank=True,
        help_text="Optional feedback for the story."
    )
...
class StoryFeedback(models.Model):
    ...
    feedback_text = models.TextField(
        help_text="Feedback for the story."
    )
    create_date = models.DateTimeField(
        auto_now_add=True,
